...
cc.Class({
    ...
    standUpChess(idx,cbFunc){
        ...
        for(var i=0;i<this.chess_stand_list.length;i++){
            this.chess_stand_list[i].setSiblingIndex(i);
        }
    ...
    moveStep(idx,num,allCallFunc){
        ...
        function handleEnd(target_place,seq1,seq2,seq3){
        ...
        function moveOnNum(num){
            ...
            if(!is_special) {
                ...
                handleEnd(target_place, seq1, seq2,seq3)
            }
        }
    ...
    backHome(chess_idx){
        ...
        if(globalData.gameMgr.isRecover){
            ...
            this.chess_list[chess_idx].getChildByName('fly').setRotation(0);
    ...
    update(){
        ...
        if(this.posId == globalData.gameMgr.turn){
            ...
            if(time_value >=0 ){
                this.img_avator_light.fillRange = - (time_value_ts/globalData.gameMgr.time_out_limit);
