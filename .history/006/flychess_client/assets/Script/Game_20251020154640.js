...
cc.Class({
    ...
    onGameStart(data){
        ...
        //     }
        // }
        // this.dice.resetPosition(data.posId);
    ...
    render(){
        let playerData = globalData.gameMgr.playerData[globalData.gameMgr.posId];
        this.btn_ready.active = (playerData && playerData.state < 2) ;
        
        var is_visible = (globalData.gameMgr.roomState.state == 0 || globalData.gameMgr.roomState.state == 2) && 
                     globalData.gameMgr.play_index < globalData.gameMgr.play_count;

        console.log(globalData.gameMgr.play_index,globalData.gameMgr.play_count,globalData.gameMgr.roomState.state)
    ...
    showDiceNum(num,posId,cbFunc) {
        ...
        this.dice.resetPosition(posId);
        this.playerNodes[posId].setTurnFlag(globalData.gameMgr.turn == posId);
    ...
    nextPlayerDice(data){
        ...
        this.dice.node.getChildByName("dice").active = false;
