...
cc.Class({
    ...
    properties: {
        ...
        player_node0:cc.Node,
        player_node1:cc.Node,
        player_node2:cc.Node,
    },
    onLoad () {

        let that = this;

        this._player_node_list[0] = this.player_node0;
        this._player_node_list[1] = this.player_node1;
        this._player_node_list[2] = this.player_node2;
