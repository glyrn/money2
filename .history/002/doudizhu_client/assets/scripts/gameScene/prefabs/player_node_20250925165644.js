    ...
    renderCard(flag,playerData,roomState) {
        ...
        for (let i = 0; i < playerData.cards.length; i++) {
            ...
            if(flag == 'self'){
                ...
                this._cardNodeList[i].position = cc.v2((i+1) * 56+base_pos.x - total_width/2,base_pos.y)
            }else if(flag == 'left'){
        ...
        //出牌
        let gap = 35;
        let total_out_width = playerData.cards.length * gap;
        ...
        for (let i = 0; i < playerData.ctxCards.length; i++) {
            ...
            this._cardOutList[i].position = cc.v2(i * gap+base_out_pos.x - total_out_width /2,0+base_out_pos.y)
