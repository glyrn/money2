...
cc.Class({
    ...
    renderCard(flag,playerData,roomState) {
        ...
        let total_width = playerData.cards.length * 55;
        ...
        for (let i = 0; i < playerData.cards.length; i++) {
            ...
            if(flag == 'self'){
                this._cardNodeList[i].setContentSize(120*1.5,163*1.5);
                this._cardNodeList[i].setRotation(0);
                this._cardNodeList[i].position = cc.v2(i * 55+base_pos.x - total_width/2,base_pos.y)
            }else if(flag == 'left'){
                this._cardNodeList[i].setContentSize(120*0.5,163*0.5);
