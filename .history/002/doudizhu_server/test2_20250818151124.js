        ...
        if((globalData.gameMgr.roomState.ctxCard.type == "ABCDE" || 
            ...
            if(is_find == false){
                ...
                for (const value in check_card_map) {
                    ...
                    if(!isAllLaizi && value > globalData.gameMgr.roomState.ctxCard.key || isAllLaizi){
                        hasAAA = true;
                        //癞子+AAA的数量 等于 出牌数量
...
let playerData = {
    ...
    cards:[{value:3},{value:6},{value:3},{value:7},{value:7},{value:3},{value:12},{value:4},{value:12},{value:12}]
}
