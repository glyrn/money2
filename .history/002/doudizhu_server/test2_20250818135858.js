            ...
            if(is_find == false){
                ...
                for (const value in check_card_map) {
                    ...
                    if(check_card_map[value] == 3 && value > Math.ceil(globalData.gameMgr.roomState.ctxCard.key)){
                        ...
                        //癞子+AAA的数量 等于 出牌数量
                        if(hasAAA && hasLaizi && curLaiziCards.length + 3 >= check_match_len){
                            playerData.cards.forEach(_card=>{
                                if(_card.value == value){
                                    select_card_list.push(_card);
                                }
                        ...
                        //癞子+AAA的数量 等于 出牌数量
                        if(hasAAA && hasLaizi && curLaiziCards.length + 2 >= check_match_len){
                            playerData.cards.forEach(_card=>{
                                if(_card.value == value){
                                    select_card_list.push(_card);
                                }
                        ...
                        //癞子+AAA的数量 等于 出牌数量
                        if(hasAAA && hasLaizi && curLaiziCards.length + 1 >= check_match_len){
                            playerData.cards.forEach(_card=>{
                                if(_card.value == value){
                                    select_card_list.push(_card);
                                }
