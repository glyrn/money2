        ...
        if((globalData.gameMgr.roomState.ctxCard.type == "ABCDE" || 
            ...
            if(is_find == false){
                ...
                for (const value in check_card_map) {
                    ...
                    // if(check_card_map[value] >= 3 || 
                    //     (curLaiziCards.length + check_card_map[value] == check_match_len && value > Math.ceil(globalData.gameMgr.roomState.ctxCard.key))
                    // ){
                        hasAAA = true;
                        //癞子+AAA的数量 等于 出牌数量
...
let playerData = {
    // cards:[{value:3},{value:3},{value:3},{value:7},{value:7},{value:12},{value:12},{value:4},{value:12},{value:12}]
