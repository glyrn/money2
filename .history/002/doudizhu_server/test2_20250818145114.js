        ...
        if((globalData.gameMgr.roomState.ctxCard.type == "ABCDE" || 
            ...
            if(is_find == false){
                ...
                for (const value in check_card_map) {
                    ...
                    if(check_card_map[value] >= 3 && value > Math.ceil(globalData.gameMgr.roomState.ctxCard.key) || true){
                        hasAAA = true;
                        //癞子+AAA的数量 等于 出牌数量
                        console.log(curLaiziCards.length + check_card_map[value], check_match_len + offset)
