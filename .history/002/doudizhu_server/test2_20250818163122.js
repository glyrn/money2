    ...
    if(globalData.gameMgr.roomState.ctxCard.key > 0){
        ...
        if((globalData.gameMgr.roomState.ctxCard.type == "ABCDE" || 
            ...
            if(is_find == false){
                ...
                let offset = isAllLaizi || ctxHasLaizi == false && check_match_len >=4 ? 1:0;
                for (const value in check_card_map) {
                    console.log("检查AAA：",value , globalData.gameMgr.roomState.ctxCard.key,offset)
                    ...
                    if((!isAllLaizi && value > Math.ceil(globalData.gameMgr.roomState.ctxCard.key)) || isAllLaizi || 
                        ...
                        hasAAA = true;
                        //癞子+AAA的数量 等于 出牌数量
                        console.log(check_match_len + offset)
...
let playerData = {
    cards:[{value:14},{value:3},{value:3},{value:5},{value:3}]
