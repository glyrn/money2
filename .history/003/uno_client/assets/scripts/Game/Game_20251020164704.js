...
cc.Class({
    ...
    renderRoom(){
        ...
        var is_visible = !globalData.gameMgr.is_quit && (globalData.gameMgr.roomState.state == 0 || globalData.gameMgr.roomState.state == 2);
        console.log(":::",globalData.gameMgr.is_quit,globalData.gameMgr.roomState.state)
