...
cc.Class({
    ...
    render(){
        ...
        var is_visible = (globalData.gameMgr.roomState.state == 0 || globalData.gameMgr.roomState.state == 2) && 
                        ...
                        // console.log(is_visible,"globalData.gameMgr.roomState.state",globalData.gameMgr.roomState.state,globalData.gameMgr.play_index,globalData.gameMgr.play_count,globalData.gameMgr.play_index >= globalData.gameMgr.play_count)
