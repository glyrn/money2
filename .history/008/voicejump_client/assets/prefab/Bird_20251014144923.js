...
cc.Class({
            ...
            if(this.state !== State.Drop){
                ...
                if(!this.img_dead.active){
                    ...
                    var seq2 = cc.sequence([
                        cc.moveTo(0.5, cc.v2(0, 100)).easing(cc.easeOut(3.0)),
                        cc.moveTo(0.5, cc.v2(0, -300)).easing(cc.easeIn(3.0)),
                    ]);
    ...
    move(data) {
        ...
        if(data.type == 1){
            ...
            if(globalData.gameMgr.isRecover){
                this.node.parent.position = cc.v2(data.cur_x + 280 ,data.cur_y);
                //镜头跟随
                if ((this.posId == globalData.gameMgr.posId && !globalData.gameMgr.is_ob) || isDeadCameraFlow) {
                    this.main_camera.x = this.node.parent.x - this._initPosX;
                }
                ...
                var seq = cc.sequence([
                    cc.moveTo(1.5, cc.v2(data.cur_x + 280 ,data.cur_y)),
                    cc.callFunc(function(){
