...
cc.Class({
    ...
    renderRoomTitle(){
        ...
        if(distance > 0){
            ...
            this.lab_timer.string = minutes + "分 " + seconds + "秒 ";
        }else{
            this.lab_timer.string = "0分0秒";
        }
    },
    render(){
        this.renderRoomTitle();
        if(globalData.gameMgr.playerData[globalData.gameMgr.posId]){
            this.btn_ready.active = globalData.gameMgr.playerData[globalData.gameMgr.posId].state < 2 ;
