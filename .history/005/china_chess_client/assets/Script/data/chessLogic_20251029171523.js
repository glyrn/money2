    ...
    this.show = function (){
        if (this.isShow) {
            if(!this.node1){
                ...
                cc.find('Canvas/tmp/center/ChessBoard').addChild(this.node1.parent,0)
            }
            ...
            if(!this.node2){
                ...
                this.node2.parent = cc.find('Canvas/tmp/center/ChessBoard')
            }
        ...
        if(this.isShow){
            for (var i=0; i<this.dots.length;i++){
                if(!this.node_list[i]){
                    ...
                    cc.find('Canvas/tmp/center/ChessBoard').addChild(this.node_list[i],0)
                }
