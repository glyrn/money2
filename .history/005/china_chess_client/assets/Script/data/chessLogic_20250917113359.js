...
//生成map里面有的棋子
chessLogic.createMans = function(map,rotation){
    for (var i=0; i<map.length; i++){
        for (var n=0; n<map[i].length; n++){
            var key = map[i][n];
            if (key){
                chessLogic.mans[key]=new chessLogic.class.Man(key,0,0,rotation);
...
chessLogic.class.Man = function (key, x, y,rotation){
    ...
    this.show = function (){
        if (this.isShow) {
            if(!this.node){
                this.node = cc.instantiate(cc.find('Canvas/center/ChessBoard/'+chessLogic.args[this.pater].img))
                this.node.parent = cc.find('Canvas/center/ChessBoard')
            }
...
chessLogic.class.Pane = function (img, x, y){
    ...
    this.show = function (){
        if (this.isShow) {
            if(!this.node1){
                this.node1 = cc.instantiate(cc.find('Canvas/center/ChessBoard/r_box'))
                this.node1.parent = cc.find('Canvas/center/ChessBoard')
            }
            ...
            if(!this.node2){
                this.node2 = cc.instantiate(cc.find('Canvas/center/ChessBoard/select_icon'))
                this.node2.parent = cc.find('Canvas/center/ChessBoard')
            }
    ...
    this.show = function (){
        ...
        if(this.isShow){
            for (var i=0; i<this.dots.length;i++){
                if(!this.node_list[i]){
                    this.node_list[i] = cc.instantiate(cc.find('Canvas/center/ChessBoard/dot'))
                    this.node_list[i].parent = cc.find('Canvas/center/ChessBoard')
                }
